...
[Dgraph Type](/docs/dql/dql-schema).
...
For more information about exporting your database, see [Export data](/docs/howto/exportdata/about-export)
...
* [Shutdown Dgraph](/docs/deploy/admin/dgraph-administration#shut-down-database) and wait for all writes to complete,
...
3. [Shutdown Dgraph](/docs/deploy/admin/dgraph-administration#shut-down-database) and wait for all writes to complete
...
5. Reload the data via [bulk loader](/docs/howto/importdata/bulk-loader)
...
Now that Dgraph is up and running, to understand how to add and query data to Dgraph, follow [Query Language Spec](/docs/query-language). Also, have a look at [Frequently asked questions](/docs/howto).
