...
|---------:|:---------|---------:|:---------|:----:|:----:|
| | | **`--acl`** | | | [Access Control List](/docs/enterprise-features/access-control-lists) superflag |
...
||| (new) [`numgoroutines`](/docs/deploy/troubleshooting) | int |`alpha`, `bulk`, `backup`| Number of Go routines used by Dgraph |
...
| Old flag | Old type | New superflag and options | New type | Applies to | Notes |
|---------:|:---------|---------:|:---------|:----:|:----:|
| | | **`--raft`** | | | [Raft](/docs/design-concepts/raft) superflag  |
...
| Old flag | Old type | New superflag and options | New type | Applies to | Notes |
|---------:|:---------|---------:|:---------|:----:|:----:|
| | | **`--tls`** | | | [TLS](/docs/deploy/security/tls-configuration) superflag  |
...
| Old flag | Old type | New superflag and options | New type | Applies to | Notes |
|---------:|:---------|---------:|:---------|:----:|:----:|
| | | **`--trace`** | | | [Tracing](/docs/deploy/admin/tracing) superflag  |
...
| Data loading     | [`bulk`](#dgraph-bulk) | Dgraph [Bulk Loader](/docs/howto/importdata/bulk-loader) commands     |
| Data loading     | [`live`](#dgraph-live) | Dgraph [Live Loader](/docs/howto/importdata/live-loader) commands     |
| Data loading     | [`restore`](#dgraph-restore) | Command used to restore backups created using Dgraph Enterprise Edition     |
| Dgraph security  | [`acl`](#dgraph-acl) | Dgraph [Access Control List (ACL)](/docs/enterprise-features/access-control-lists) commands |
...
This command is used to load live data with the Dgraph [Live Loader](/docs/howto/importdata/live-loader) tool.
...
This command lets you manage [TLS certificates](/docs/deploy/security/tls-configuration).
...
To learn more, see [Using the Debug Tool](/docs/howto/using-debug-tool).
...
This command is used to convert a [binary backup](/docs/enterprise-features/binary-backups)
...
see [Using the Increment Tool](/docs/howto/using-increment-tool).
...
Edition. To learn more, see [Backup List Tool](/docs/enterprise-features/lsbackup).
...
This command runs the Dgraph [migration tool](/docs/migration/migrate-tool)
