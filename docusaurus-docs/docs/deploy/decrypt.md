...
[Dgraph Administration: Export database](/docs/deploy/admin/dgraph-administration#export-database).
...
[Dgraph CLI Command Reference](/docs/deploy/cli-command-reference).
