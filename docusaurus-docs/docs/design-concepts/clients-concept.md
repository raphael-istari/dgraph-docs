...
Dgraph provides [client libraries](/docs/dql/clients) for many languages. These clients send DQL queries, and perform useful functions such as logging in, in idomatic ways in each language.
