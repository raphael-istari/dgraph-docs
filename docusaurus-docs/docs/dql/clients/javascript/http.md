...
This client follows the [Dgraph JavaScript gRPC client](/docs/grpc) closely.
...
1. Alpha servers can be configured with [Secure Alter Operations](/docs/dgraph-administration).
