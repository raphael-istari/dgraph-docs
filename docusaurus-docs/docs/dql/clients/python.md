...
In [multi-tenancy](/docs/enterprise-features/multitenancy) environments, PyDgraph provides a new method `login_into_namespace()`,
...
See more about Conditional Upserts [here](/docs/dql/mutations#conditional-upsert).
