...
Filtering on a predicate by applying a [function](/docs/query-language/functions) requires an index.

Indices are defined in the Dgraph types schema using `@index` directive.
