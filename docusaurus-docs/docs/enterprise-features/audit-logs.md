...
[enterprise license](/docs/enterprise-features/license), you can
...
* GRPC requests to Raft endpoints (see [RAFT](/docs/design-concepts/raft))
...
To learn more about the logging features of Dgraph, see [Logging](/docs/log-format).
