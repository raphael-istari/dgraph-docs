...
With a Dgraph [enterprise license](/docs/enterprise-features/license),
...
When you enable CDC in a [multi-tenant environment](/docs/enterprise-features/multitenancy),
