...
In the [previous tutorial](/docs/tutorial-3/index), we learned about Datatypes, Indexing, Filtering, and Reverse traversals in Dgraph.
...
```
_Note: If this mutation syntax is new to you, refer to the first tutorial to learn basics of mutation in Dgraph._
...
_Note: Check out the previous tutorial to know more about data types in Dgraph._
...
_Note: Check the second tutorial if you want to learn more about traversal queries like the above one_
...
_Note: If you're not clear about basic terminology like `predicates`, do read the first tutorial._
...
Check out our next tutorial of the getting started series [here](/docs/tutorial-5/index).
