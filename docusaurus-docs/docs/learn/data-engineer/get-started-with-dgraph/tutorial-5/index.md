...
In the [previous tutorial](/docs/tutorial-4/index), we learned about using multi-language strings and operations on them using [language tags](https://www.w3schools.com/tags/ref_language_codes.asp).
...
_Note: If you're new to Dgraph, and yet to figure out how to run the database and use Ratel, we highly recommend reading the [first article of the series](/docs/learn/data-engineer)_
...
_Note: If the query syntax above looks not so familiar to you, check out the [first tutorial](/docs/learn/data-engineer)._
...
_Note: If the traversal query syntax in the above query is not familiar to you, [check out the third tutorial](/docs/tutorial-3/index) of the series._
...
_Note: Refer to [the third tutorial](/docs/tutorial-3/index), if you want to know about comparator functions like `eq` in detail._
...
We discussed in the [third tutorial](/docs/tutorial-3/index) that there five comparator functions in Dgraph.
...
_Note: Check out [the first tutorial](/docs/learn/data-engineer) if the query syntax, in general, is not familiar to you_
...
Check out our next tutorial of the getting started series [here](/docs/tutorial-6/index).
