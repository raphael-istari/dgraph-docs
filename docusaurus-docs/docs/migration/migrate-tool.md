...
For description of the various flags in the migration tool, see [command line options](/docs/about-data-migration).
...
The two files can then be imported into Dgraph using the [Dgraph Live Loader](/docs/howto/importdata/live-loader)
or [Bulk Loader](/docs/howto/importdata/bulk-loader). Sometimes you might want to customize your schema.
