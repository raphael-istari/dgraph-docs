...
use `expand()`, the [type system](/docs/dql/dql-schema) is required.
...
(see [language preference](/docs/query-language/graphql-fundamentals#language-support)).  So it's often
